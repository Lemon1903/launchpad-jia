...
export default function CheckboxRenderer({ questionIndex, control }: QuestionRendererProps) {
  ...
  return (
    <div className="checkbox-renderer">
        ...
        <Controller
          ...
          render={({ field: controllerField, fieldState }) => (
            <Field orientation="horizontal" data-invalid={fieldState.invalid}>
              <FieldContent>
                <div className="checkbox-renderer__option">
                  <InputGroup>
                    <InputGroupInput
                      {...controllerField}
      ...
      <Button
        variant="ghost"
        size="sm"
        className="checkbox-renderer__add-option"
