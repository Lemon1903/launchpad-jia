...
import { candidateActionToast, deleteCareer, errorToast } from "@/lib/Utils";
    ...
    const fetchOrgDetails = async () => {
      try {
        ...
        setAvailableJobSlots(
          (orgDetails.data?.plan?.jobLimit || 3) + (orgDetails.data?.extraJobSlots || 0),
        );
      } catch (error) {
  ...
  return (
    <>
                              ...
                              <div className="media align-items-center">
                                <div className="media-body">
                                  <h3
                                    ...
                                    style={{ fontSize: "16px", fontWeight: 550, color: "#111827" }}
                                  >
                                    {item.jobTitle}
                                  </h3>
                                </div>
      ...
      {totalActiveCareers >= availableJobSlots && (
        <Tooltip className="career-fit-tooltip fade-in" id="add-career-tooltip" />
      )}
    </>
  );
}
